        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              Collect your fresh treats from our Soho bakery within your chosen
              time window.
            </p>
          </button>
      ...
      <section className="flex flex-col gap-5 pb-8 lg:pb-0">
        <div>
          ...
          <p className="text-sm text-on-surface-variant mt-1">
            Live 30-minute windows from your bakery&apos;s opening hours and
            capacity.
          </p>
        </div>
        <div className="bg-surface-container-lowest p-6 rounded-2xl border border-surface-container shadow-sm">
          ...
          {selectedTimeLabel && (
            <p className="text-xs text-on-surface-variant mt-3">
              Selected:{" "}
              <strong className="text-primary">{selectedDate}</strong> ·{" "}
              {selectedTimeLabel}
            </p>
          )}
        </div>
