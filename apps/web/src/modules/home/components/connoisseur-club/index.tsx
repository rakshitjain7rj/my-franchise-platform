  ...
  return (
    <section className="rounded-3xl overflow-hidden bg-deep-plum text-white premium-shadow">
      <div className="flex flex-col lg:flex-row items-stretch min-h-[460px]">
        ...
        <div className="flex-1 p-6 sm:p-8 md:p-16 flex flex-col justify-center space-y-6 sm:space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="font-headline text-2xl sm:text-4xl md:text-5xl font-extrabold leading-tight">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 py-2">
            <div className="border-l-2 border-vibrant-magenta pl-4 space-y-1">
              <p className="text-xl sm:text-2xl font-bold tracking-tight">1000 Points</p>
              <p className="text-[10px] uppercase tracking-widest opacity-60 font-label-bold">
                Signature Cake Reward
              </p>
            </div>
            <div className="h-px w-12 sm:h-10 sm:w-px bg-white/10" />
            <div className="border-l-2 border-vibrant-magenta pl-4 space-y-1">
              <p className="text-xl sm:text-2xl font-bold tracking-tight">Priority</p>
              <p className="text-[10px] uppercase tracking-widest opacity-60 font-label-bold">
          ...
          <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-2">
            <a
              className="bg-white text-deep-plum px-7 sm:px-10 py-3 sm:py-3.5 rounded-full font-label-bold text-xs uppercase tracking-widest hover:bg-vibrant-magenta hover:text-white transition-all duration-300 active:scale-95 shadow-lg"
              href="#"
            >
              Join Now
            </a>
